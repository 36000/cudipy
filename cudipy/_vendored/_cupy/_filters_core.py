"""
vendored copy of cupyx/scipy/ndimage/_filters_core.py

added locally: has_channel argument
"""
import warnings
...
from cudipy._vendored._cupy import _util
